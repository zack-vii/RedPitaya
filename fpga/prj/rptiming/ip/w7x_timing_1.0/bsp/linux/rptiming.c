...
static int rp_timing_probe(struct platform_device *pdev) {
...
static int rp_timing_remove(struct platform_device *pdev) {
...
static const struct of_device_id rp_timing_of_ids[] = {
    { .compatible = "xlnx,w7x-timing-1.0",},
	{}
};

static struct platform_driver rp_timing_driver = {
	.driver = {
        .name  = MODULE_NAME,
		.owner = THIS_MODULE,
        .of_match_table = rp_timing_of_ids,
	},
    .probe = rp_timing_probe,
    .remove = rp_timing_remove,
};

static int __init rp_timing_init(void)
{
    printk(KERN_INFO "inizializing AXI rp_timing module ...\n");
    return platform_driver_register(&rp_timing_driver);
}

static void __exit rp_timing_exit(void)
{
    printk(KERN_INFO "exiting AXI rp_timing module ...\n");
    platform_driver_unregister(&rp_timing_driver);
}

module_init(rp_timing_init);
module_exit(rp_timing_exit);
MODULE_LICENSE("GPL");
