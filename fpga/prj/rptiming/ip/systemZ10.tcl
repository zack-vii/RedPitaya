...
CONFIG.FREQ_HZ {125000000} \
  ...
  set state0 [ create_bd_port -dir O -from 0 -to 0 -type data state0 ]
  set state1 [ create_bd_port -dir O -from 7 -to 2 -type data state1 ]
  set state_led [ create_bd_port -dir O -from 7 -to 0 -type data state_led ]
  set trg_in [ create_bd_port -dir I trg_in ]
...
CONFIG.PCW_USE_S_AXI_HP1 {1} \
  ...
  set timing_0 [ create_bd_cell -type ip -vlnv w7x:ip:timing:1.0 timing_0 ]
  set_property -dict [ list \
...
CONFIG.XADC_STARUP_SELECTION {independent_adc} \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins timing_0/s00_axi]
  ...
  connect_bd_intf_net -intf_net timing_0_BRAM_PORTA [get_bd_intf_pins blk_mem_gen_0/BRAM_PORTA] [get_bd_intf_pins timing_0/BRAM_PORTA]
  connect_bd_intf_net -intf_net timing_0_BRAM_PORTB [get_bd_intf_pins blk_mem_gen_0/BRAM_PORTB] [get_bd_intf_pins timing_0/BRAM_PORTB]

  # Create port connections
  connect_bd_net -net clk_in_1 [get_bd_ports clk_in] [get_bd_pins timing_0/clk_ext_in]
  connect_bd_net -net gnd_0_dout [get_bd_ports state0] [get_bd_pins gnd_0/dout]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins proc_sys_reset/peripheral_aresetn] [get_bd_pins timing_0/s00_axi_resetn] [get_bd_pins xadc/s_axi_aresetn]
  ...
  connect_bd_net -net processing_system7_0_fclk_clk2 [get_bd_ports FCLK_CLK2] [get_bd_pins processing_system7/FCLK_CLK2] [get_bd_pins timing_0/clk_int_in]
  connect_bd_net -net processing_system7_0_fclk_clk3 [get_bd_ports FCLK_CLK3] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_protocol_converter_0/aclk] [get_bd_pins proc_sys_reset/slowest_sync_clk] [get_bd_pins processing_system7/FCLK_CLK3] [get_bd_pins processing_system7/M_AXI_GP0_ACLK] [get_bd_pins processing_system7/M_AXI_GP1_ACLK] [get_bd_pins timing_0/clk_axi_in] [get_bd_pins xadc/s_axi_aclk]
  ...
  connect_bd_net -net timing_0_state_do [get_bd_ports state1] [get_bd_pins timing_0/state_do]
  connect_bd_net -net timing_0_state_led [get_bd_ports state_led] [get_bd_pins timing_0/state_led]
  connect_bd_net -net trg_in_1 [get_bd_ports trg_in] [get_bd_pins timing_0/trig_in]
  ...
  create_bd_addr_seg -range 0x00080000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7/Data] [get_bd_addr_segs timing_0/s00_axi/reg0] SEG_timing_0_reg0
